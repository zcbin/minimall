<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/comment/list']" class="filter-item" type="primary" icon="el-icon-search"
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['POST /admin/comment/reply']" type="primary" size="mini"
                     @click="handleReply(scope.row)">回复
          </el-button>
          <el-button v-permission="['POST /admin/comment/delete']" type="danger" size="mini"
